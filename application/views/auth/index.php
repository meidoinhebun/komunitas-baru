    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-full">
            <div class="bg-image">
                <div style="background-image: url('assets/images/natback.jpg');"></div>
            ...
            <div class="nk-header-table">
                <div class="nk-header-table-cell">
                    <div class="container">
                        ...
                        <h2 class="nk-subtitle text-white">WELCOME TO</h2>


                        <h1 class="nk-title display-3 text-white">Nature Photography</h1>
        ...
        <div class="nk-box bg-white" id="projects">
            ...
            <h2 class="text-xs-center display-4">Our Gallery</h2>
                    ...
                    <div class="nk-isotope-item" data-filter="Mockup">
                        <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                            ...
                            <div class="nk-portfolio-item-image">
                                <div style="background-image: url('assets/images/Alam Papua 2.jpeg');"></div>
                            </div>
